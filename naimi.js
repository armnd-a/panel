...
const isOwner = setting.ownerNumber == m.sender ? true : ["6287823406145@s.whatsapp.net"].includes(m.sender) ? true : false
...
*� Language :* JavaScript
*� Prefix :* Multi
*� Donted t :* https://link.dana.id/qr/7bghx66m

     	*�  Dte nd Time  �*   
  WIT    :${moment().utcOffset('+0900').format('HH:mm')} WIT
...
*Language :* JavaScript
*Prefix :* Multi
*Donated  :* https://link.dana.id/qr/7bghx66m
...
_*ANIME MENU*_
 ...
 
 Thnks For People Involved On Mking.
 Hppy Use User !
 If You Found Bug Plese For Red Terms And Conditions.
 Soon For Mny Fetures !
 More Informtion Owner, Type *.Owner* To See it
 Wnt To Know About us? You Cn Type *.About* !
...
try {
if (setting.keyopenai === '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') return reply('Apikey belum diisi\n\nSilahkan isi terlebih dahulu apikeynya di file key.json\n\nApikeynya bisa dibuat di website: https://beta.openai.com/account/api-keys')
...
url: 'https://instagram.com/armnd.at'
}
}, {
quickReplyButton: {
displayText: 'MENU',
...
if (!isRegister) return reply(blomdaftar) & sendButMessage (sender, daftar1, daftar2, daftar3, { quoted: m}) 
    if (isBan) return reply(mess.banned)
    buttonss2 = [
{buttonId: `${prefix}owner`, buttonText: {displayText: 'O W N E R'}, type: 1}
]
pa3 = {
text: listmn,
footer: `© ${setting.botName} bot`,
...
urlButton: {
displayText: 'DONASI',
url: 'https://link.dana.id/qr/7bghx66m'
}
}, {
urlButton: {
displayText: 'INSTAGRAM',
